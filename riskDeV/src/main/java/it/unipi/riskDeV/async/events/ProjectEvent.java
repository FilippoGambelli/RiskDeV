...
public sealed interface ProjectEvent {
    ...
    record ProjectCreated(String projectName, String adminUsername, List<String> packageIds) implements ProjectEvent {}
    record ProjectDeleted(String projectName, List<String> involvedCollaborators) implements ProjectEvent {}
    record ProjectPackagesUpdated(String projectName, List<String> packageIds) implements ProjectEvent {}
